...
def bits_para_x(bits):
    ...
    maior_valor = (2 ** len(bits)) - 1
    return X_MIN + (decimal / maior_valor) * (X_MAX - X_MIN)
...
def fitness(individuo):
    ...
    """
    # A roleta requer valores não negativos; o ótimo global continua sendo preservado.
    return max(0.0, float(funcao_objetivo(bits_para_x(individuo))))
