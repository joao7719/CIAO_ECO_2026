...
if __name__ == '__main__':
    rota, custo, historico, feromonio = executar_aco(seed=7)
    print('========== RESULTADO ==========')
    print('Melhor rota encontrada:', rota)
    print('Melhor custo:', custo)
    plt.plot(historico); plt.xlabel('Iteração'); plt.ylabel('Melhor custo'); plt.title('Evolução do melhor custo'); plt.grid(); plt.savefig('AULA_06/evolucao_lab04.png'); plt.close()
